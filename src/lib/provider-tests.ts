...
export const PROVIDER_TESTS: ProviderTestConfig[] = [
  ...
  },
  {
    ...
    modelLabel: "starts with current direct Anthropic Claude IDs",
    allowModelOverride: true,
    title: "Anthropic guided test",
    summary: "Runs one tiny messages request through Tokenometer using current direct Anthropic model IDs. If your organization uses Bedrock or Vertex, this direct test will not be the right path.",
